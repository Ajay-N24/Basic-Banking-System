    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #13203f;" data-bs-theme="dark">
            ...
            <div class="row container custom-row1">
              <div class="col-lg-6 row-1">
                ...
                <button class="btn btn-lg" style="background-color: #ffb93f; color: black;" onclick="window.location.href = 'all-customer.php';">Get Started</button>
              </div>
              <div class="col-lg-6">
    ...
    <div class="container">
      ...
      <div class="row services-row">
        ...
        <i class="fas fa-duotone fa-user-group fa-6x"></i>
          ...
          <button class="btn" style="background-color: #ffb93f;" onclick="window.location.href = 'all-customer.php';">View Customers</button>
        </div>
        <div class="col services-col">
        <i class="fas fa-duotone fa-money-bill-transfer fa-6x"></i>
          <h3>Transfer Money</h3>
          <p>Transfer Money from One account to another.<p>
          <button class="btn" style="background-color: #ffb93f;" onclick="window.location.href = 'send-money.php';">Tranfer</button>
        </div>
        <div class="col services-col">
